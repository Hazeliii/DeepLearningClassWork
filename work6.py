...
def training_options():
    ...
    lr_reducer = ReduceLROnPlateau(factor=,
                                   cooldown=,
                                   patience=,
                                   min_lr=,
                                   verbose=)
    ...
    batch_size = 128
    load_weight = False  # 是否选加载预训练模型参数，True or False
...
if load_weight:
    mobilenet.load_weights('./mobilenet_v2_weights_tf_dim_ordering_tf_kernels_1.0_160_no_top.h5')
